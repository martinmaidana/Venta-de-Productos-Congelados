...
const productosTotales = [
    { nombre: "esparragos", precio: 700, stock: 4, carro: 0, img: 'esparragos.jpg' },
    { nombre: "brocoli", precio: 800, stock: 8, carro: 0, img:'brocoli.jpg' },
    { nombre: "espinacas", precio: 900, stock: 2, carro: 0, img:'espinaca.webp' },
    { nombre: "zanahorias", precio: 1000, stock: 1, carro: 0, img:'zanahoria.jpg' },
    { nombre: "zapallo", precio: 1200, stock: 6, carro: 0, img:'zapallo.jpg' },
    { nombre: "repollo", precio: 1100, stock: 0, carro: 0, img:'repollo.webp' },
]

const productos = productosTotales.filter((producto) => producto.stock >= 0);

let i = 1;
// usando query selector .  ingrese las etiquetas div al html y con for of, recorry el array de objetos. con if . else if y else en funcion del stock y usando clases de css diferencie si el stock esta por agotarse o esta agotado.
let data = '';
let vstock = '';
